...
def main(req):
    ...
    print("Found blobs: " + str(blob_names))
    ...
    print(f"Number of small pdfs: {len(small_pdfs)}")
    ...
    print("Cleaned paragraphs. Number of paragraphs now: ", len(cleaned_paragraphs))

    split_paragraphs = split_long_paragraphs(cleaned_paragraphs)

    print("Split paragraphs. Number of paragraphs now: ", len(split_paragraphs))

    print('Extracted {} paragraphs'.format(len(split_paragraphs)))
    print('First paragraph: {}'.format(split_paragraphs[0]))
    print('Last paragraph: {}'.format(split_paragraphs[-1]))


    print("Now embedding paragraphs")
    embed_price = embed_paragraphs(split_paragraphs, namespace, index_name)
    print("Done embedding paragraphs")

    print("Total price: $", price + embed_price) 


class Request:
    def __init__(self, id, file_names, project):
        self.id = id
...
if __name__ == "__main__":
    req = Request("sid:61fdee33eb5fc49c1e82df86d649c8cd", ["sid:61fdee33eb5fc49c1e82df86d649c8cd/michael/michael.pdf"], "michael")
    main(req)
...
# Delete the online deployment
az ml online-deployment delete --name blue --endpoint $ENDPOINT_NAME $local_flag -y

# Delete the online endpoint
az ml online-endpoint delete --name $ENDPOINT_NAME $local_flag -y
